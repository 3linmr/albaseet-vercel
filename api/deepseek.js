...
1. استخدم سطرين فارغين بين كل قسم رئيسي
2. أضف سطر فارغ قبل كل رقم (1. 2. 3.)
3. أضف سطر فارغ قبل كل عنوان أو تبويب
4. اجعل كل نقطة في سطر منفصل
5. لا تستخدم رموز markdown مثل * أو # أو **
6. نظم المعلومات في فقرات منفصلة وواضحة

مثال على التنسيق المطلوب:

لإضافة صنف جديد في نظام witsUP، اتبع هذه الخطوات:

1. الوصول إلى الشاشة
من الشاشة الرئيسية، انتقل إلى:
تأسيس → الأصناف → الأصناف → إضافة جديد

2. تبويب البيانات الأساسية
الحقول المطلوبة:
- اسم الصنف بالعربية (إلزامي)
- اسم الصنف بالإنجليزية (إلزامي)
- النشاط (إلزامي)

3. تبويب سياسات التسعير
الحقول المطلوبة:
- سعر الشراء (افتراضي: 0)
- سعر وحدة المفرد (افتراضي: 0)
- السعر الداخلي (افتراضي: 0)

4. تبويب الباركود والشد
الحقول المتاحة:
- الباركود (حقل رقمي)
- سعر الوحدة (حقل رقمي)
- الشد (قائمة منسدلة)
...
5. تبويب وصف الأصناف
الحقول المتاحة:
- سمة الصنف (قائمة منسدلة)
- قيمة السمة بالعربية (حقل نصي)
- قيمة السمة بالإنجليزية (حقل نصي)

6. تبويب معرفات الأصناف
الخصائص الإضافية:
- لا يباع (غير مفعل افتراضياً)
- يباع بنظام النقاط (غير مفعل)
- له رقم تشغيلة (غير مفعل)

7. تبويب ملاحظات
الحقول المتاحة:
- معرف الملاحظة (قائمة منسدلة)
- قيمة الملاحظة (حقل نصي)
- ملاحظة (حقل نصي متعدد الأسطر)

أزرار التحكم النهائية:
- حفظ (لحفظ الصنف الجديد)
- عودة (للعودة بدون حفظ)
- تفريغ (لمسح جميع الحقول)

تذكر: يجب أن تضع سطرين فارغين بين كل قسم رئيسي (1. 2. 3. 4. 5. 6. 7.) وسطر فارغ قبل كل عنوان أو تبويب. هذا مهم جداً للتنسيق.
...
تذكر: يجب أن تضع سطرين فارغين بين كل رقم (1. 2. 3.) وسطر فارغ قبل كل عنوان. هذا إلزامي للتنسيق.`;
