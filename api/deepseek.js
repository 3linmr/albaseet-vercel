...
1. استخدم سطرين فارغين بين كل فقرة رئيسية
2. أضف سطر فارغ قبل كل رقم أو نقطة جديدة (1. 2. 3.)
3. أضف سطر فارغ قبل كل عنوان أو قسم جديد
4. اجعل كل نقطة في سطر منفصل
5. استخدم مسافات مناسبة بين العناصر المختلفة
6. لا تستخدم رموز markdown مثل * أو # أو **
7. نظم المعلومات في فقرات منفصلة وواضحة
8. اجعل كل قسم منفصل بوضوح عن الآخر
9. استخدم تنسيق واضح ومنظم للخطوات والإرشادات
10. تأكد من أن النص سهل القراءة والتنظيم

مثال على التنسيق المطلوب:

إليك الخطوات التفصيلية لإضافة صنف جديد:
...
- سعر وحدة المفرد (افتراضي: 0)`;
        ...
        try {
            ...
            if (data.choices && data.choices[0] && data.choices[0].message) {
                ...
                // تنظيف وتحسين التنسيق بشكل أكثر فعالية
