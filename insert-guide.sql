...
UPDATE guide_content SET content = 'هذا الدليل يحتوي على شرح شامل لجميع شاشات نظام witsUP، مرتبة حسب
تسلسل الاستخدام الطبيعي للمستخدم.
### هيكل نظام witsUP الرئيسي
```
شاشة الدخول
...
### التحديثات
- هذا الدليل يتم تحديثه باستمرار مع إضافة ميزات جديدة
- يرجى مراجعة هذا الدليل قبل استخدام أي شاشة جديدة' WHERE id = 1;
